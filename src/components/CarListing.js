...
function CarListing(props) {
  ...
  function isItNew() {
    return (props.car.isNew) ? "New" : "Used";
  }
  ...
  return (<div className="col-md-4 grid_listing">
    <div className="product-listing-m gray-bg">
      <div className="product-listing-img"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">
        <img src={props.car.imgUrl} className="img-responsive" alt="" /> </a>
        <div className="label_icon">{isItNew()}</div>
      ...
      <div className="product-listing-content">
        ...
        <div className="car-location"><span><i className="fa fa-map-marker" aria-hidden="true"></i> {props.car.city}</span></div>
