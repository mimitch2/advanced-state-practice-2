            ...
            <div className="container">
              <div className="row">
                <div className="col-sm-3 col-md-2">
                  <div className="logo"> <a href="http://themes.webmasterdriver.net/carforyou/demo/index.html"><img src="./logo.png" alt="" /></a> </div>
                </div>
            ...
            <div className="row">
              <div className="col-md-9 col-md-push-3">
                ...
                <div className="row">
                  ...
                  {filterCars().map((car, index) => {return <CarListing car={car} key={index} />;})}
                  ...
                  <div className="sidebar_filter">
                    <form action="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#" method="get">
                      <div className="form-group select">
                        <select className="form-control" 
                          onChange={(e) => this.setState({currentYear: e.target.value})}>
                          <option>Select Year</option>
                          {allYears.map((year) => {return <option value={year} key={year}>{year}</option>;})}
                        </select>
                      </div>
                      <div className="form-group select">
                        <select className="form-control">
                  ...
                  <div className="recent_addedcars">
                    <ul>
                      <li className="gray-bg">
                        <div className="recent_post_img"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./post_200x200_1.jpg" alt="" /></a> </div>
                      ...
                      <li className="gray-bg">
                        <div className="recent_post_img"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./post_200x200_2.jpg" alt="" /></a> </div>
                        <div className="recent_post_title"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">BMW 535i</a>
                          <p className="widget_price">$92,000</p>
                        </div>
                      </li>
                      <li className="gray-bg">
                        <div className="recent_post_img"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./post_200x200_3.jpg" alt="" /></a> </div>
                      ...
                      <li className="gray-bg">
                        <div className="recent_post_img"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./post_200x200_4.jpg" alt="" /></a> </div>
                        <div className="recent_post_title"> <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">Ford Shelby GT350 </a>
                          <p className="widget_price">$92,000</p>
                        </div>
                      </li>
                ...
                <div className="owl-wrapper-outer">
                  <div className="owl-wrapper" style={{width: "2040px", left: "0px", display: "block", transition: "all 800ms ease", transform: "translate3d(-204px, 0px, 0px)"}}>
                    <div className="owl-item" style={{width: "204px"}}><div>
                      <a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./brand-logo-1.png" className="img-responsive" alt="" /></a></div>
                    </div><div className="owl-item" style={{width: "204px"}}><div><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">
                      <img src="./brand-logo-2.png" className="img-responsive" alt="" /></a></div></div><div className="owl-item" style={{width: "204px"}}>
                        <div><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./brand-logo-3.png" className="img-responsive" alt="" /></a></div>
                      </div><div className="owl-item" style={{width: "204px"}}><div><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#">
                        <img src="./brand-logo-4.png" className="img-responsive" alt="" /></a></div></div><div className="owl-item" style={{width: "204px"}}>
                          <div><a href="http://themes.webmasterdriver.net/carforyou/demo/listing-grid.html#"><img src="./brand-logo-5.png" className="img-responsive" alt="" /></a></div>
                        </div></div></div>
